...
import com.example.lubble.loginRegistration.LoginActivity;
...
public class Camera2Fragment extends Fragment implements
    ...
    private RelativeLayout mStillshotContainer, mFlashContainer, mSwitchOrientationContainer,
            ...
            mSaveContainer, mStickerContainer, mTrashContainer, mUploadContainer, mFilesBtnContainer, mSignoutContainer;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.stillshot).setOnTouchListener(this);
        ...
        view.findViewById(R.id.upload_stillshot).setOnClickListener(this);
        view.findViewById(R.id.init_sticker_icon).setOnClickListener(this);
        view.findViewById(R.id.ib_files).setOnClickListener(this);
        view.findViewById(R.id.ib_signout).setOnClickListener(this);

        progressBar = view.findViewById(R.id.pb_upload);
        ...
        mUploadContainer = view.findViewById(R.id.upload_container);
        ...
        mFilesBtnContainer = view.findViewById(R.id.rl_files_container);
        mSignoutContainer = view.findViewById(R.id.signout_button_container);
        ...
        //mUploadContainer.setOnClickListener(this);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.ib_files: {
                Intent intent = new Intent(view.getContext(), UploadsActivity.class);
                view.getContext().startActivity(intent);
                break;
            }

            case R.id.ib_signout: {
    ...
    public void dragStickerStarted() {
        if (mStillshotImageView.mSelectedStickerIndex != -1) {
            ...
            mUploadContainer.animate().alpha(0.0f).setDuration(ICON_FADE_DURATION);
    ...
    public void dragStickerStopped() {
        if (mStillshotImageView.mSelectedStickerIndex == -1) {
            ...
            mUploadContainer.animate().alpha(1.0f).setDuration(0);
    ...
    private void upload(final View v) {
        ...
        builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                final TextInputEditText title = dialogView.findViewById(R.id.dialog_tiet_upload);
                ...
                if (title.getText().toString().length() == 0) {
                    ...
                    final UploadTask image_path = storageReference.child(firebaseAuth.getUid().toString()).child(title.getText().toString() + ".jpg").putBytes(thumbData);
                    ...
                    image_path.addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                storageReference.child(firebaseAuth.getUid()).child(title.getText().toString() + ".jpg").getDownloadUrl()
                                        .addOnSuccessListener(new OnSuccessListener<Uri>() {
                                            ...
                                            public void onSuccess(Uri uri) {
                                                ...
                                                firebaseFirestore.collection("users").document(firebaseAuth.getUid())
                                                        .collection("images").document(title.getText().toString())
                                                        .set(map, SetOptions.merge())
                                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                            @Override
                                                            public void onSuccess(Void aVoid) {
                                                                Toast.makeText(v.getContext(), "Image Uploaded", Toast.LENGTH_LONG).show();
                                        ...
                                        .addOnFailureListener(new OnFailureListener() {
                                            ...
                                            public void onFailure(@NonNull Exception e) {
                                                ...
                                                Toast.makeText(v.getContext(), "(IMAGE Error) : " + error, Toast.LENGTH_LONG).show();
                            ...
                            .addOnFailureListener(new OnFailureListener() {
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    String error = e.toString();
                                    Toast.makeText(v.getContext(), "(File Error) : " + error, Toast.LENGTH_LONG).show();
                                    progressBar.setVisibility(View.INVISIBLE);
                                }
                            });
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (view.getId() == R.id.stillshot) {
            Log.d("onTouch", motionEvent.toString() + "!");

            switch (motionEvent.getAction()) {

                case MotionEvent.ACTION_DOWN: {
                    down = motionEvent.getEventTime();
                    //record video here
                    break;
                }

                case MotionEvent.ACTION_UP: {
                    up = motionEvent.getEventTime();

                    if (down != 0 && up != 0) {
                        if (up - down > 1000) {
                            Log.d("onTOUCH", "recording video");
                        } else {
                            Log.d("onTOUCH", "Taking picture");
                            takePicture();
                        }
                    }
                    break;
    ...
    private void resetIconVisibilities() {
        ...
        mFilesBtnContainer.setVisibility(View.VISIBLE);
        mSignoutContainer.setVisibility(View.VISIBLE);
        mTrashContainer.setVisibility(View.INVISIBLE);
    ...
    private void showStillshotContainer() {
        ...
        mFilesBtnContainer.setVisibility(View.INVISIBLE);
        mSignoutContainer.setVisibility(View.VISIBLE);
